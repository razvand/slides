# variables required througout rules
OUT_DIR = texfiles
CODE_DIR = code
STY_DIR = ../include
FORMAT_DIR = ../include/format/
PDFLATEX = pdflatex
...
$(NOTES) $(HANDOUT) $(HANDOUT_4ON1) $(HANDOUT_8ON1) $(DUALSCREEN): $(BASENAME)-%.pdf: $(FORMAT_DIR)/%.tex
	...
	-test -d $(CODE_DIR) && test -f $(CODE_DIR)/Makefile && make -C $(CODE_DIR)
...
clean:
	...
	-rm -f $(SLIDES) $(NOTES) \
		$(HANDOUT) $(HANDOUT_4ON1) $(HANDOUT_8ON1) $(DUALSCREEN)
	-test -d $(CODE_DIR) && test -f $(CODE_DIR)/Makefile && make -C $(CODE_DIR) clean
