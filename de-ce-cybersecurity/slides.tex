...
\title[De ce cybersecurity?]{De ce să învăț cybersecurity?}
\institute{Vizită ACS - CNMB}
...
\begin{frame}{Dezvoltare / scris cod vs. Bug hunting vs Securitate / Wargames}
  \centering
  \pause
  \vspace{0.5cm}
...
\begin{frame}{De ce să învăț cybersecurity?}
  \centering
  \pause
  \vspace{0.5cm}
  \Large{provocare} \\
...
\begin{frame}{Ce trebuie pentru cybersecurity?}
  \begin{itemize}
    \pause
    \item rețelistică
    \pause
...
\begin{frame}{Ce (mai) trebuie pentru cybersecurity?}
  \begin{itemize}
    \pause
    \item răbdare
    \pause
...
\begin{frame}{Pentru cybersecurity \ldots}
  \centering
  \pause
  \vspace{0.5cm}
  ...
  \pause
  \vspace{0.5cm}
  \Large{\ldots{} le înveți, având ca \textbf{obiectiv} cybersecurity.}
\end{frame}
...
\begin{frame}{Nu e greu pentru începători?}
  ...
  \pause
  \vspace{0.3cm}
  \large{(Comunitatea de) cybersecurity îți dă probleme. Scenarii. Wargames. CTF.} \\
  \pause
  \vspace{0.3cm}
