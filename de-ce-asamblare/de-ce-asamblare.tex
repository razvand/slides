...
\begin{frame}{Exemple din securitatea ofensivă}
  \begin{itemize}
    ...
    \pause \item serviciu de tip \textit{hello} configurat pe mașina virtuală
...
\begin{frame}{Nevoia de debugging}
  ...
  \pause \textbf{codul în limbaj de asamblare}\\
\end{frame}
...
\begin{frame}{Bazele limbajului de asamblare}
  \begin{itemize}
    \item datele rezidă în memorie
    \item datele sunt aduse din memorie în registrele procesorului
    \item procesorul face operații cu datele din registre
    \item rezultatele operațiilor sunt scrise înapoi în memorie
    \item unele informații pot fi preluate și transmise către dispozitive de intrare/ieșire
  \end{itemize}
\end{frame}
